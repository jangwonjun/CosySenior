...
from modules.sw2 import univ_ratio_2
...
@sched.scheduled_job('cron', second='*/10', id='univ_ratio_check2')
def univ_ratio_check_2():
    current_time = time.strftime("%H:%M:00")
    print(current_time)
    univ_ratio_2("대학경쟁률 실시간 조회(학교별로 업데이트 시간이 달라요!)")  
